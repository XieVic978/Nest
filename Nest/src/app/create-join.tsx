...
// The room home lives at the (room) group index. Typed as Href because the
// generated route types don't always include the bare group-index path.
const ROOM_HOME = "/(room)" as Href;

export default function CreateJoinScreen() {
  return <View style={styles.screen}><Text style={styles.title}>Create or join a home</Text><Pressable onPress={() => router.replace(ROOM_HOME)} style={styles.button}><Text style={styles.buttonText}>Create a home</Text></Pressable><Pressable onPress={() => router.replace(ROOM_HOME)} style={styles.secondary}><Text style={styles.secondaryText}>Join a home</Text></Pressable></View>;
}
