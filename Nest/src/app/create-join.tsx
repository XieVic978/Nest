...
const styles = StyleSheet.create({
  ...
  profileButton: { position: "absolute", right: 24, top: 54, borderColor: "#E4E8E8", borderWidth: 1, borderRadius: 14, paddingHorizontal: 14, paddingVertical: 10, backgroundColor: "#FFFFFF" },
  profileButtonText: { color: "#4975A8", fontSize: 14, fontWeight: "900" },
  content: { flexGrow: 1, justifyContent: "center", padding: 24, paddingVertical: 64 },
  center: { flex: 1, alignItems: "center", justifyContent: "center", gap: 14, padding: 28, backgroundColor: "#FFFCF5" },
  eyebrow: { color: "#4975A8", fontSize: 12, fontWeight: "900", letterSpacing: 1.8, marginBottom: 10 },
  title: { color: "#24374B", fontFamily: "Georgia", fontSize: 36, fontWeight: "700", letterSpacing: -0.8 },
  body: { color: "#6B7785", fontSize: 16, lineHeight: 23, marginTop: 10 },
  segmented: { flexDirection: "row", marginTop: 30, padding: 4, borderRadius: 16, backgroundColor: "#F0F3F3" },
  segment: { flex: 1, alignItems: "center", borderRadius: 11, paddingVertical: 11 },
  segmentActive: { backgroundColor: "#FFFFFF" },
  segmentText: { color: "#6B7785", fontWeight: "800" },
  segmentTextActive: { color: "#4975A8" },
  card: { marginTop: 16, padding: 20, borderRadius: 22, backgroundColor: "#FFFFFF", borderColor: "#E4E8E8", borderWidth: 1 },
  cardTitle: { color: "#24374B", fontFamily: "Georgia", fontSize: 23, fontWeight: "700", marginBottom: 20 },
  label: { color: "#6B7785", fontSize: 11, fontWeight: "800", letterSpacing: 1, marginBottom: 8 },
  input: { borderWidth: 1, borderColor: "#E4E8E8", borderRadius: 14, paddingHorizontal: 14, paddingVertical: 14, color: "#24374B", backgroundColor: "#FFFFFF", fontSize: 16 },
  helper: { color: "#6B7785", fontSize: 13, lineHeight: 19, marginTop: 10 },
  primaryButton: { minHeight: 50, alignItems: "center", justifyContent: "center", marginTop: 20, borderRadius: 14, paddingHorizontal: 18, backgroundColor: "#4975A8" },
  primaryButtonText: { color: "#FFFFFF", fontSize: 15, fontWeight: "900" },
  pressed: { opacity: 0.86 },
  disabled: { opacity: 0.6 },
  error: { color: "#B95048", fontSize: 14, lineHeight: 20, marginTop: 14 },
  modalBackdrop: { flex: 1, alignItems: "center", justifyContent: "center", padding: 24, backgroundColor: "rgba(36,55,75,.46)" },
  ...
  cancelButton: { flex: 1, alignItems: "center", justifyContent: "center", borderRadius: 12, padding: 14, backgroundColor: "#F0F3F3" },
  cancelText: { color: "#4D6072", fontWeight: "900" },
  dangerButton: { flex: 1.4, alignItems: "center", justifyContent: "center", borderRadius: 12, padding: 14, backgroundColor: "#EE8069" },
});
