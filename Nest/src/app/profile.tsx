...
const styles = StyleSheet.create({
  safe: { flex: 1, backgroundColor: "#FFFCF5" },
  screen: { flexGrow: 1, backgroundColor: "#FFFCF5", padding: 24, paddingTop: 36, paddingBottom: 32 },
  header: { flexDirection: "row", justifyContent: "space-between", alignItems: "flex-start" },
  title: { fontFamily: "Georgia", fontSize: 34, fontWeight: "700", color: "#24374B" },
  email: { marginTop: 8, fontSize: 14, color: "#6B7785" },
  backToNest: {
    backgroundColor: "#4975A8",
    borderRadius: 14,
    paddingHorizontal: 16,
    paddingVertical: 12,
  },
  buttonText: { color: "white", fontWeight: "800" },
  card: { backgroundColor: "#FFFFFF", borderColor: "#E4E8E8", borderRadius: 20, borderWidth: 1, marginTop: 28, padding: 18 },
  cardTitle: { color: "#24374B", fontFamily: "Georgia", fontSize: 20, fontWeight: "700" },
  label: { color: "#6B7785", fontSize: 11, fontWeight: "800", letterSpacing: 1, marginBottom: 7, marginTop: 18 },
  input: { backgroundColor: "#FFFFFF", borderColor: "#E4E8E8", borderRadius: 14, borderWidth: 1, color: "#24374B", fontSize: 15, padding: 13 },
  save: { alignItems: "center", backgroundColor: "#4975A8", borderRadius: 14, marginTop: 22, padding: 14 },
