const ERROR_MESSAGES: Record<string, string> = {
  ...
  cannot_remove_self: "Use Leave Nest from your profile instead.",
  ...
  invite_expired: "That invitation expired. Ask a roommate for the permanent Nest code.",
  invite_revoked: "That invitation is no longer active. Ask a roommate for the permanent Nest code.",
  member_is_admin: "Every member has equal access in Nest.",
  membership_not_found: "This person is no longer a member of the Nest.",
  nest_admin_required: "Every Nest member has equal access.",
